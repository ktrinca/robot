...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { credit: @case.credit, description: @case.description, link: @case.link, nature: @case.nature, picture: @case.picture, subtitle: @case.subtitle }
    end
  ...
  test "should update case" do
    put :update, id: @case, case: { credit: @case.credit, description: @case.description, link: @case.link, nature: @case.nature, picture: @case.picture, subtitle: @case.subtitle }
    assert_redirected_to case_path(assigns(:case))
  end
